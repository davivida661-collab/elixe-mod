...
public class OnRenderEntityEvent {
	...
	public void unsetBrightness() {
		((elixe.mixin.AccessorRendererLivingEntity) renderer).invokeUnsetBrightness();
	}
	
	public boolean setBrightness() {
		return ((elixe.mixin.AccessorRendererLivingEntity) renderer).invokeSetDoRenderBrightness(entity, partialTicks);
	}
	
	public void renderModel() {
		((elixe.mixin.AccessorRendererLivingEntity) renderer).invokeRenderModel(entity, renderLimbSwing, renderLimbSwingAmount, renderAgeInTicks, renderHeadYaw, renderHeadPitch, renderScaleFactor);
	}
