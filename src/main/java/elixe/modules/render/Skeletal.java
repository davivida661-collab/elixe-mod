...
public class Skeletal extends Module {
	...
	private Listener<OnTickEvent> onTickEvent = new Listener<>(e -> {
		...
		for (Entity ent : mc.theWorld.loadedEntityList) {
			// guard 'rendered' removido na migração
	...
	private Listener<OnSetModelAngles> onSetModelAngles = new Listener<>(e -> {
		...
		if (model.isRiding) {
			// perna direita
			modelsRot[0] = new ModelRotations(scale, ((elixe.duck.IModelHeight) model.bipedRightLeg).elixe$getHeight(), -model.bipedLeftLeg.rotateAngleX, model.bipedLeftLeg.rotateAngleY,
			...
			// perna esquerda
			modelsRot[1] = new ModelRotations(scale, ((elixe.duck.IModelHeight) model.bipedLeftLeg).elixe$getHeight(), -model.bipedRightLeg.rotateAngleX, model.bipedRightLeg.rotateAngleY,
			...
			// perna direita
			modelsRot[0] = new ModelRotations(scale, ((elixe.duck.IModelHeight) model.bipedRightLeg).elixe$getHeight(), model.bipedRightLeg.rotateAngleX, model.bipedRightLeg.rotateAngleY,
			...
			// perna esquerda
			modelsRot[1] = new ModelRotations(scale, ((elixe.duck.IModelHeight) model.bipedLeftLeg).elixe$getHeight(), model.bipedLeftLeg.rotateAngleX, model.bipedLeftLeg.rotateAngleY,
		...
		if (sneak) {
			// corpo
			modelsRot[2] = new ModelRotations(scale, ((elixe.duck.IModelHeight) model.bipedBody).elixe$getHeight(), model.bipedBody.rotateAngleX, model.bipedBody.rotateAngleY,
			...
			// braço direito
			modelsRot[3] = new ModelRotations(scale, ((elixe.duck.IModelHeight) model.bipedRightArm).elixe$getHeight() - 2, model.bipedRightArm.rotateAngleX, model.bipedRightArm.rotateAngleY,
			...
			// braço esquerdo
			modelsRot[4] = new ModelRotations(scale, ((elixe.duck.IModelHeight) model.bipedLeftArm).elixe$getHeight() - 2, model.bipedLeftArm.rotateAngleX, model.bipedLeftArm.rotateAngleY,
			...
			modelsRot[2] = new ModelRotations(scale, ((elixe.duck.IModelHeight) model.bipedBody).elixe$getHeight(), model.bipedBody.rotateAngleX, model.bipedBody.rotateAngleY,
					-model.bipedBody.rotateAngleZ, model.bipedBody.rotationPointX, model.bipedBody.rotationPointY, model.bipedBody.rotationPointZ);
			// braço direito
			modelsRot[3] = new ModelRotations(scale, ((elixe.duck.IModelHeight) model.bipedRightArm).elixe$getHeight() - 2, -model.bipedLeftArm.rotateAngleX, model.bipedLeftArm.rotateAngleY,
					-model.bipedLeftArm.rotateAngleZ, model.bipedRightArm.rotationPointX, model.bipedRightArm.rotationPointY,
					model.bipedRightArm.rotationPointZ);
			// braço esquerdo
			modelsRot[4] = new ModelRotations(scale, ((elixe.duck.IModelHeight) model.bipedLeftArm).elixe$getHeight() - 2, -model.bipedRightArm.rotateAngleX, model.bipedRightArm.rotateAngleY,
		...
		if (connectBones) {
	        ...
	        //final do corpo
			Vec3 vecBodyEnd = vecBody.addVector(vecDirectional.xCoord * ((elixe.duck.IModelHeight) model.bipedBody).elixe$getHeight(), 
					-vecDirectional.yCoord * ((elixe.duck.IModelHeight) model.bipedBody).elixe$getHeight(), 
					-vecDirectional.zCoord * ((elixe.duck.IModelHeight) model.bipedBody).elixe$getHeight());
