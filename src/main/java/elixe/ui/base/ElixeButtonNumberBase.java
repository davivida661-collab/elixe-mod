...
public class ElixeButtonNumberBase extends ElixeButtonBase {
	...
	public void drawText(int mouseX, int mouseY) {
		elixe.utils.misc.FontUtil.drawStringWithShadow(fontrenderer, text, x, mid - fontrenderer.FONT_HEIGHT / 2, 0.86f, 1f); // 220
		elixe.utils.misc.FontUtil.drawStringWithShadow(fontrenderer, minS, x, sliderMid - fontrenderer.FONT_HEIGHT / 2, 0.7f, 1f); // 180
		elixe.utils.misc.FontUtil.drawStringWithShadow(fontrenderer, maxS, x + width - maxWid, sliderMid - fontrenderer.FONT_HEIGHT / 2, 0.7f, 1f); // 180
		elixe.utils.misc.FontUtil.drawString(fontrenderer, valueS, startX + difX / 2 - valueWid / 2, sliderMid - fontrenderer.FONT_HEIGHT / 2,
				0.07f, 1f); // 20
	}
