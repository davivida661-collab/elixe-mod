...
public class ElixeColorButton extends ElixeButtonBase {
	...
	public ElixeColorButton(IElixeMenu menu, String text, ModuleColor opt, int x, int y, int wid, int hei) {
	...
	public void drawText(int mouseX, int mouseY) {
		elixe.utils.misc.FontUtil.drawStringWithShadow(fontrenderer, text, x, y + height / 2f - fontrenderer.FONT_HEIGHT / 2, 0.86f, 1f); // 220
	}
	...
	public void drawButton(int mouseX, int mouseY) {
		...
		// line: accent when the picker is open
		if (pickerOpen) {
